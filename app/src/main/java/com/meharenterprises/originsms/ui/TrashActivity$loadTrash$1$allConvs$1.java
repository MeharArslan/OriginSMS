...
@DebugMetadata(c = "com.meharenterprises.originsms.ui.TrashActivity$loadTrash$1$allConvs$1", f = "TrashActivity.kt", i = {}, l = {149}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class TrashActivity$loadTrash$1$allConvs$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends ConversationSummary>>, Object> {
    int label;
    final /* synthetic */ TrashActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TrashActivity$loadTrash$1$allConvs$1(TrashActivity trashActivity, Continuation<? super TrashActivity$loadTrash$1$allConvs$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TrashActivity$loadTrash$1$allConvs$1(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<ConversationSummary>> continuation) {
        return ((TrashActivity$loadTrash$1$allConvs$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
