...
@DebugMetadata(c = "com.meharenterprises.originsms.ui.thread.ThreadActivity$confirmHideChat$1$2$1", f = "ThreadActivity.kt", i = {}, l = {355}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes10.dex */
public final class ThreadActivity$confirmHideChat$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ThreadActivity$confirmHideChat$1$2$1(ThreadLockDao threadLockDao, ThreadLockEntity threadLockEntity, ThreadActivity threadActivity, Continuation<? super ThreadActivity$confirmHideChat$1$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ThreadActivity$confirmHideChat$1$2$1(this.$dao, this.$existing, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ThreadActivity$confirmHideChat$1$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object $result) {
        ThreadLockEntity copy;
        ThreadActivity$confirmHideChat$1$2$1 threadActivity$confirmHideChat$1$2$1;
        ...
        threadActivity$confirmHideChat$1$2$1.this$0.finish();
